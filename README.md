...
- 예약 시에는 **물품 가액 전액**을 입금해 주셔야 예약이 확정됩니다.
- 혼선을 줄이기 위해 예약금이 아닌 전액 입금 기준으로 운영합니다. 예약 만료나 중복 입금이 발생한 경우 기존 입금분은 수동 환불해 드립니다.
...
행사장에는 키캡, 스위치 등 현장에서 바로 가져가실 수 있는 다양한 물건의 나눔도 예정되어 있습니다.
